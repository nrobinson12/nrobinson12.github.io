...
function App() {
  ...
  const renderLink = (data, key) => {
    return (
      <a className="link" href={data.link} target="_blank" rel="noopener noreferrer" key={key}>{data.name}</a>
    );
  }
  ...
  return (
    <div className="app">
      ...
      <div className="main">
        ...
        <div className="blurb slide-up">I am a software developer currently studying computer science at the University of Waterloo. I have experience in full stack development, working with multiple different companies and projects touching all areas of the development process.<br /><br />My passion is in learning new ideas and concepts. Whether that be a new language or framework, to a whole new mindset or lifestyle change.</div>
      </div>
